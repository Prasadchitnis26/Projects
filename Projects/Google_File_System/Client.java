...
public class Client extends UnicastRemoteObject implements ClientInt,Runnable {
	...
	protected Client(int x) throws RemoteException {
		super();
		this.id=x;
		// TODO Auto-generated constructor stub
	}
	...
	@Override
	/*
	 * This method is used to get the setup complete for the client 
	...
	public static void main(String args[]) throws IOException, AlreadyBoundException {
		s=new ServerSocket(10500);
		Registry Naming = LocateRegistry.createRegistry(10000);
		client=new Client();
		Client c=new Client();
		Client c2=new Client();
		Naming.bind("Client", c);
	...
	@Override
	/*
	 * This method is used when the main master is down so as to make the backup the current master
	 */
	...
	@Override
	/*
	 * This method is used when the client wants to append data to an existing file
	 */
	...
	@Override
	/*
	 * This method is used when the client wants to overwrite data to an existing file
	 */
	...
	@Override
	/*
	 * This method is used when the client wants to read data from an existing file
	 */
	public void read(String s) throws UnknownHostException,RemoteException{
		BufferedReader br=new BufferedReader(new InputStreamReader(System.in));
		int n=m.nChunk(s);
		System.out.println(s);
		System.out.println("enter out of "+n+" which chunk you want to read on and enter -1 to read the complete file");
		int k=0;
		try {
			k = Integer.parseInt(br.readLine());
