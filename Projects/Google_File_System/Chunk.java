 ...
 **/
public class Chunk extends UnicastRemoteObject implements ChunkInt,Runnable {
	static MasterInt m;
	static Registry r;
	...
	protected Chunk() throws RemoteException {
		super();
		// TODO Auto-generated constructor stub
	}
	protected Chunk(int x) throws RemoteException {
		super();
		this.id=x;
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String args[]) throws IOException, AlreadyBoundException {
		s=new ServerSocket(31500);
		buffer=new String[100][2];
		Registry Naming = LocateRegistry.createRegistry(31000);
		Chunk c=new Chunk();
		Chunk c2=new Chunk();
		Naming.bind("Chunk1", c);
		new Thread(new Chunk(0)).start();
	//	new Thread(new Chunk(1)).start();
		c2.setup();
