 ...
 **/
public class Chunk3 extends UnicastRemoteObject implements ChunkInt,Runnable {
	static MasterInt m;
	static Registry r;
	...
	protected Chunk3() throws RemoteException {
		super();
		// TODO Auto-generated constructor stub
	}
	protected Chunk3(int x) throws RemoteException {
		super();
		this.id=x;
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String args[]) throws IOException, AlreadyBoundException {
		s=new ServerSocket(33500);
		buffer=new String[100][2];
		Registry Naming = LocateRegistry.createRegistry(33000);
		Chunk3 c=new Chunk3();
		Chunk3 c2=new Chunk3();
		Naming.bind("Chunk3", c);
		new Thread(new Chunk3(0)).start();
		//new Thread(new Chunk3(1)).start();
		c2.setup();
