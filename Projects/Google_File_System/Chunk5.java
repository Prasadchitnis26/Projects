 ...
 **/
public class Chunk5 extends UnicastRemoteObject implements ChunkInt,Runnable {
	static MasterInt m;
	static Registry r;
	...
	protected Chunk5() throws RemoteException {
		super();
		// TODO Auto-generated constructor stub
	}
	protected Chunk5(int x) throws RemoteException {
		super();
		this.id=x;
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String args[]) throws IOException, AlreadyBoundException {
		...
		Registry Naming = LocateRegistry.createRegistry(35000);
		Chunk5 c=new Chunk5();
		Chunk5 c2=new Chunk5();
		Naming.bind("Chunk5", c);
		new Thread(new Chunk5(0)).start();
	//	new Thread(new Chunk5(1)).start();
		c2.setup();
