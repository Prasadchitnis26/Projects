 ...
 **/
public class Chunk6 extends UnicastRemoteObject implements ChunkInt,Runnable {
	static MasterInt m;
	static Registry r;
	...
	protected Chunk6() throws RemoteException {
		super();
		// TODO Auto-generated constructor stub
	}
	protected Chunk6(int x) throws RemoteException {
		super();
		this.id=x;
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String args[]) throws IOException, AlreadyBoundException {
		s=new ServerSocket(36500);
		buffer=new String[100][2];
		Registry Naming = LocateRegistry.createRegistry(36000);
		Chunk6 c=new Chunk6();
		Chunk6 c2=new Chunk6();
		Naming.bind("Chunk6", c);
		new Thread(new Chunk6(0)).start();
		//new Thread(new Chunk6(1)).start();
		c2.setup();
