 ...
 **/
public class Chunk4 extends UnicastRemoteObject implements ChunkInt,Runnable {
	static MasterInt m;
	static Registry r;
	...
	protected Chunk4() throws RemoteException {
		super();
		// TODO Auto-generated constructor stub
	}
	protected Chunk4(int x) throws RemoteException {
		super();
		this.id=x;
		// TODO Auto-generated constructor stub
	}
	...
	public static void main(String args[]) throws IOException, AlreadyBoundException {
		s=new ServerSocket(34500);
		buffer=new String[100][2];
		Registry Naming = LocateRegistry.createRegistry(34000);
		Chunk4 c=new Chunk4();
		Chunk4 c2=new Chunk4();
		Naming.bind("Chunk4", c);
		new Thread(new Chunk4(0)).start();
		//new Thread(new Chunk4(1)).start();
		c2.setup();
