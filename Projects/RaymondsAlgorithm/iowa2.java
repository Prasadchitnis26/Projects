 ...
 **/
public class iowa2 implements Runnable {
	int id;
	static String state = "RELEASED";
	static LinkedList<String> list = new LinkedList<String>();
	static int forward = 0;
	static String myAddr = "iowa.cs.rit.edu", holder = "iowa.cs.rit.edu";
	static boolean transmitted = false, hasToken = true, addedToList = false, reqSent = false;
	...
	public static void main(String args[]) throws IOException {
		...
		new Thread(new iowa2(0)).start();
		new Thread(new iowa2(1)).start();
		new Thread(new iowa2(2)).start();
		new Thread(new iowa2(3)).start();
