 ...
 **/
public class idaho2 implements Runnable {
	int id;
	static String state = "RELEASED";
	static LinkedList<String> list = new LinkedList<String>();
	static int forward = 0;
	static String myAddr = "idaho.cs.rit.edu", holder = "nebraska.cs.rit.edu";
	...
	public static void main(String args[]) throws IOException {
		...
		new Thread(new idaho2(0)).start();
		new Thread(new idaho2(1)).start();
		new Thread(new idaho2(2)).start();
		new Thread(new idaho2(3)).start();
	}
