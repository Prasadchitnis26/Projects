...
public class serverid implements Runnable {
	int id;
	static int count = 2;
	static DatagramSocket serverSocket;
	static String myAddr = "idaho.cs.rit.edu";
	...
	public static void main(String args[]) throws IOException {
		...
		list=new InetAddress[4];
		 ...
		 list[2] = InetAddress.getByName("newyork.cs.rit.edu");
		 list[3] = InetAddress.getByName("glados.cs.rit.edu");
		serverSocket = new DatagramSocket(35000);
		new Thread(new serverid(0)).start();
		new Thread(new serverid(1)).start();
		new Thread(new serverid(2)).start();
		new Thread(new serverid(3)).start();
	}
