...
public class serverK implements Runnable {
	int id;
	static int count = 0;
	static DatagramSocket serverSocket;
	static String myAddr = "kansas.cs.rit.edu";
	...
	public static void main(String args[]) throws IOException {
		...
		list[0] = InetAddress.getByName("newyork.cs.rit.edu");
		 list[1] = InetAddress.getByName("iowa.cs.rit.edu");
		 list[2] = InetAddress.getByName("idaho.cs.rit.edu");
		 list[3] = InetAddress.getByName("glados.cs.rit.edu");
		serverSocket = new DatagramSocket(35000);
		new Thread(new serverK(0)).start();
		new Thread(new serverK(1)).start();
		new Thread(new serverK(2)).start();
		new Thread(new serverK(3)).start();
	}
