...
public class serverN implements Runnable {
	int id;
	static int count = 4;
	static DatagramSocket serverSocket;
	static String myAddr = "newyork.cs.rit.edu";
	...
	public static void main(String args[]) throws IOException {
		...
		new Thread(new serverN(0)).start();
		new Thread(new serverN(1)).start();
		new Thread(new serverN(2)).start();
		new Thread(new serverN(3)).start();
	}
