...
public class serverio implements Runnable {
	...
	static String myAddr = "iowa.cs.rit.edu";
	...
	public static void main(String args[]) throws IOException {
		...
		list=new InetAddress[4];
		 ...
		 list[1] = InetAddress.getByName("newyork.cs.rit.edu");
		...
		new Thread(new serverio(0)).start();
		new Thread(new serverio(1)).start();
		new Thread(new serverio(2)).start();
		new Thread(new serverio(3)).start();
	}
